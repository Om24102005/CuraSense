...
import { Activity, Brain, FileText, History, LayoutDashboard,
  Settings as SettingsIcon, Menu, X, User, Sun, Moon
} from 'lucide-react';
...
export default function App() {
  ...
  const handleGetStarted = () => setShowWelcome(false);
  ...
  // ── CSS Variables injected at root for theme ────────────────────────────────
      ...
      >
        ...
        <div className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between py-4">
                ...
                <div className="flex items-center gap-2">
                  {/* Profile */}
                  <button
                    className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-300"
                    style={{
              ...
              {mobileMenuOpen && (
                <div
                  className={`md:hidden pb-4 border-t mt-2 pt-4 ${borderColor}`}
                >
          ...
          <main id="page-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            {/* Page headings — shared styled helper */}
            {activeTab === 'analyze' && (
              <div>
                <div className="mb-8">
